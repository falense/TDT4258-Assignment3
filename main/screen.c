...
void setBlock(unsigned int bx,unsigned int by, Block b){
	...
	if (simpleBlock){
		...
		switch(b){
			case Food:
				image = loadBitmap("./resources/images/food.bmp");
				break;
			case Ghost1:
				image = loadBitmap("./resources/images/ghost1.bmp");
				break;
			case Ghost2:
				image = loadBitmap("./resources/images/ghost2.bmp");
				break;
			case Ghost3:
				image = loadBitmap("./resources/images/ghost3.bmp");
				break;
			case Pacman:
				image = loadBitmap("./resources/images/pacman.bmp");
				break;
		}
		if (!image){
